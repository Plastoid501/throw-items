...
public class ItemListWidget extends ElementListWidget<ItemListWidget.Entry> {
    ...
    public class ItemEntry extends Entry {
        ...
        ItemEntry(Text itemId, Item item, TextRenderer textRenderer, ModConfig config, String listName) {
            ...
            this.addButton.active = !ItemUtil.contains(Configs.throwItems.getStacks().get(this.listName), item.getDefaultStack());
            this.removeButton.active = ItemUtil.contains(Configs.throwItems.getStacks().get(this.listName), item.getDefaultStack());
        ...
        @Override
        void update() {
            if (ItemUtil.contains(Configs.throwItems.getStacks().get(this.listName), this.item.getDefaultStack())) {
